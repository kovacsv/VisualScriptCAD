...
NE::DynamicSerializationInfo	VectorValue::serializationInfo (NE::ObjectId ("{197F02C6-847C-4D6B-BD94-8C4BB587E36F}"), NE::ObjectVersion (1), VectorValue::CreateSerializableInstance);
...
std::wstring VectorValue::ToString (const NE::StringSettings& stringSettings) const
{
	std::wstring result = L"";
	result += L"Point (";
	result += NE::DoubleToString (val.x, stringSettings);
