...
VisualScriptCAD is a simple experimental 3D modeling application based on [VisualScriptEngine](https://github.com/kovacsv/VisualScriptEngine). You can create fully parametric 3D models and export them to various 3D file formats.
